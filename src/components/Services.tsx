  ...
  const getFeatures = (key: string): string[] => {
    const translations = {
      es: {
        ...
        'service.introspection.features': ['26 semanas de duración', '3 horas por sesión', 'Grupos en español e inglés', 'Solo mujeres 21-70 años', 'Cupo limitado'],
        ...
        'service.accompaniment.features': ['26 semanas de duración', 'Sesiones de 2 horas', 'Grupos en español e inglés', 'Hombres y mujeres 21-80 años', 'Cupo limitado'],
      ...
      en: {
        ...
        'service.introspection.features': ['26-week duration', '2-hour sessions', 'Spanish and English groups', 'Women only 21-80 years', 'Limited capacity'],
        ...
        'service.accompaniment.features': ['26-week duration', '2-hour sessions', 'Spanish and English groups', 'Men and women 21-80 years', 'Limited capacity'],
