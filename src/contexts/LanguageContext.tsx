...
const translations = {
  es: {
    ...
    'about.p1': 'Soy Paola Echartea Cruz, psicóloga especializada en terapias de expansión de consciencia y acompañamiento en estados amplificados de consciencia. Mi enfoque integra la psicología clínica tradicional con sabidurías ancestrales y educación e integración para experiencias no ordinarias.',
  ...
  en: {
    ...
    'about.p1': 'I am Paola Echartea Cruz, a psychologist specialized in consciousness expansion therapies and accompaniment in amplified states of consciousness. My approach integrates traditional clinical psychology with ancestral wisdom and education and integration for non-ordinary experiences.',
