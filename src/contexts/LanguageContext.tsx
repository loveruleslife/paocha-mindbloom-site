...
const translations = {
  es: {
    ...
    'service.individual.description': 'Apoyo y acompañamiento psicológico personalizado para ayudarte a procesar la información y las emociones que emergen durante y después de una experiencia en estados amplificados de consciencia.\nEl trabajo se realiza de forma individual desde el enfoque de la psicología transpersonal, con el objetivo de brindarte herramientas sólidas que te permitan integrar y dar sentido a tu vivencia.\nUtilizamos recursos como la atención plena, la escritura creativa, la pintura como medio de expresión, y preguntas de reflexión profunda, entre otras técnicas. Estas herramientas podrás seguir aplicándolas en tu vida cotidiana para continuar tu proceso de crecimiento y autoconocimiento.',
  ...
  en: {
    ...
    'service.individual.description': 'Personalized psychological support and accompaniment to help you process the information and emotions that emerge during and after an experience in amplified states of consciousness.\nThe work is carried out individually from a transpersonal psychology approach, with the goal of providing you with solid tools that allow you to integrate and make sense of your experience.\nWe use resources such as mindfulness, creative writing, painting as a means of expression, and deep reflection questions, among other techniques. You can continue applying these tools in your daily life to continue your process of growth and self-knowledge.',
