...
const translations = {
  es: {
    ...
    'service.therapy.description': 'Sesiones personalizadas con una terapeuta entrenada en múltiples marcos terapéuticos y psicológicos para acompañarte en tu proceso de introspección y autoconocimiento.',
